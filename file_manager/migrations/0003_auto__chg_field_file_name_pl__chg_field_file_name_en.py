...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'File.name_pl'
        db.alter_column(u'file_manager_file', 'name_pl', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'File.name_en'
        db.alter_column(u'file_manager_file', 'name_en', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        u'file_manager.file': {
            ...
            'name_pl': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
