...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Banner.title_en'
        db.alter_column(u'banner_banner', 'title_en', self.gf('django.db.models.fields.CharField')(default='', max_length=80))

        # Changing field 'Banner.description_en'
        db.alter_column(u'banner_banner', 'description_en', self.gf('django.db.models.fields.TextField')(default='', max_length=1024))

        # Changing field 'Banner.description_pl'
        db.alter_column(u'banner_banner', 'description_pl', self.gf('django.db.models.fields.TextField')(default='', max_length=1024))

        # Changing field 'Banner.title_pl'
        db.alter_column(u'banner_banner', 'title_pl', self.gf('django.db.models.fields.CharField')(default='', max_length=80))
    ...
    models = {
        u'banner.banner': {
            ...
            'title_pl': ('django.db.models.fields.CharField', [], {'max_length': '80', 'null': 'True', 'blank': 'True'}),
