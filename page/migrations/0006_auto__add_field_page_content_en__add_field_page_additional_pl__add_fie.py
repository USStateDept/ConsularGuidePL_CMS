...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'page_page', 'content_en',
                      self.gf('django.db.models.fields.TextField')(default='ww'),
                      keep_default=False)

        # Adding field 'Page.additional_pl'
        db.add_column(u'page_page', 'additional_pl',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Page.additional_en'
        db.add_column(u'page_page', 'additional_en',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Page.additional_pl'
        db.delete_column(u'page_page', 'additional_pl')

        # Deleting field 'Page.additional_en'
        db.delete_column(u'page_page', 'additional_en')
