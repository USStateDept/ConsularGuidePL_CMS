...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Feedback.active'
        db.add_column(u'feedback_feedback', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Feedback.active'
        db.delete_column(u'feedback_feedback', 'active')
    ...
    models = {
        ...
        u'page.page': {
            ...
            'editors': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "u'edited_pages'", 'symmetrical': 'False', 'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_permission_parent': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'latitude': ('django.db.models.fields.FloatField', [], {'default': '52.229902', 'null': 'True', 'blank': 'True'}),
            'level': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'longitude': ('django.db.models.fields.FloatField', [], {'default': '21.012669', 'null': 'True', 'blank': 'True'}),
            ...
            'zoom': ('django.db.models.fields.IntegerField', [], {'default': '13', 'null': 'True', 'blank': 'True'})
        }
    }
