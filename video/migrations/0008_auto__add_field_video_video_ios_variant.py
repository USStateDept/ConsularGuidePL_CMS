...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Video.video_ios_variant'
        db.add_column(u'video_video', 'video_ios_variant',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Video.video_ios_variant'
        db.delete_column(u'video_video', 'video_ios_variant')
