...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Video.video_android3'
        db.add_column(u'video_video', 'video_android3',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Video.video_ios3'
        db.add_column(u'video_video', 'video_ios3',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Video.video_android3'
        db.delete_column(u'video_video', 'video_android3')

        # Deleting field 'Video.video_ios3'
        db.delete_column(u'video_video', 'video_ios3')
