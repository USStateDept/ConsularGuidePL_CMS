...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'video_video', 'title_en', self.gf('django.db.models.fields.CharField')(max_length=120))

        # Changing field 'Video.title_pl'
        db.alter_column(u'video_video', 'title_pl', self.gf('django.db.models.fields.CharField')(max_length=120))
